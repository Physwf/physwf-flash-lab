package com.physwf.engine.fight.effects
{
	...
	public class EffectSystem
	{
		...
		public static const DROP_THOUDER4:EffectConfig = new EffectConfig(MissileEffect,DIR_EFFECT+17,400);
		public static const DROP_THOUDER5:EffectConfig = new EffectConfig(TornadoEffect,DIR_EFFECT+5,400);
		public static const DROP_THOUDER6:EffectConfig = new EffectConfig(TornadoEffect,DIR_EFFECT+6,400);
		public static const DROP_THOUDER7:EffectConfig = new EffectConfig(TornadoEffect,DIR_EFFECT+7,400);
		public static const DROP_THOUDER8:EffectConfig = new EffectConfig(TornadoEffect,DIR_EFFECT+8,400);
		public static const DROP_THOUDER9:EffectConfig = new EffectConfig(TornadoEffect,DIR_EFFECT+9,400);
		public static const DROP_THOUDER10:EffectConfig = new EffectConfig(TornadoEffect,DIR_EFFECT+10,400);
