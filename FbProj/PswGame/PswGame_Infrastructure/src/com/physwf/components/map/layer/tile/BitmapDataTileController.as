package com.physwf.components.map.layer.tile
{
	...
	public class BitmapDataTileController implements ITileController
	{
		...
		public function BitmapDataTileController(bmd:BitmapData)
		{
		...
		{
			_qTree = new QuadTree(6,new Rectangle(0,0,MapBase.W,MapBase.H));
