...
package starling.display
{
    ...
    public class QuadBatch extends DisplayObject
    {
        ...
        //扩展顶点数据的容量，只在两个地方被调用，分别为addQuad()何addQuadBatch()
                                ...
                                blendMode:String=null):void
        {
            ...
            if (mNumQuads == 0) // QuadBatch的相关属性同第一个添加进来的Quad相同
            {
        ...
        // program management
        // 这个函数只在 两种情况下被调用，参加onContextCreated()方法和expand()方法
        private static function registerPrograms():void
        {
            ...
            //将每一种可能的组合的片段着色器构建出来，然后按一定的名称顺序存储，留备后用
