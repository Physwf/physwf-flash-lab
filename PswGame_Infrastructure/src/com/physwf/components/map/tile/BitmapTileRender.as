package com.physwf.components.map.tile
{
	...
	public class BitmapTileRender implements ITileRender
	{
		...
		public function BitmapTileRender(mapDisplay:Sprite)
		{
		...
		{
			_qTree = new QuadTree(4,new Rectangle(0,0,TileBasedMap.W,TileBasedMap.H));
